...
def get_usdt_pairs():
    """ Returns all pairs with USDT as quote available on the future market """
...
def get_contract_klines(pair: str, intervals: str, contractType='PERPETUAL', startTime=None, endTime=None, limit=1500):
    ...
    params = {'pair': pair.upper(), 'interval': intervals.lower(), 'limit': limit, 'contractType': contractType}
    if startTime != None:
        params['startTime'] = startTime
    if endTime != None:
        params['endTime'] = endTime
